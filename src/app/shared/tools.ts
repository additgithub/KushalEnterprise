...
export class Tools {
    ...
    constructor(
        ...
        public toastController: ToastController, public network: Network, private platform: Platform,
            ...
            buttons:  [
                {
                    ...
                    handler: () => {
                        if(status==401){
                            ...
                            localStorage.clear();
                            console.log('User Data ', localStorage.getItem('cui-data'));
